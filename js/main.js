...
const fallbackTranslations = {
  en: {
    ...
    "txt-other-projects-title": "<i class=\"fas fa-cubes\" style=\"color: #38bdf8;\"></i> Other Projects",
    "txt-other-projects-desc": "Explore my other web apps and tools designed to make development and learning easier.",
    "txt-sql-title": "SQL Cheat Sheet",
    "txt-sql-desc": "Interactive SQL query guide and quick reference cheat sheet.",
    "txt-cta-sql": "Visit Site &rarr;",
    ...
    /* MENU_TRANS_EN_START */
        ...
        "txt-opt-2": "2 → System Health Checker",
        "txt-opt-3": "3 → One-Click Maintenance",
        "txt-opt-4": "4 → Updates & Drivers Center",
        "txt-opt-5": "5 → Memory Optimizer",
        "txt-opt-6": "6 → Defrag & Optimize Drives",
        "txt-opt-7": "7 → Power & Battery Utilities",
        "txt-opt-8": "8 → Visual FX Booster",
        "txt-opt-9": "9 → Smart Uninstaller",
        "txt-opt-10": "10 → Remote Desktop (RDP) Manager",
        "txt-opt-11": "11 → Enhanced Junk Cleaner",
        "txt-opt-12": "12 → Clear App Caches",
        "txt-opt-13": "13 → Clear Browser Caches",
        "txt-opt-14": "14 → Empty Recycle Bin",
        "txt-opt-15": "15 → Open Disk Cleanup",
        "txt-opt-16": "16 → Clear Event Logs",
        "txt-opt-17": "17 → Network Repair",
        "txt-opt-18": "18 → DNS Changer",
        "txt-opt-19": "19 → Wi-Fi Password Recovery",
        "txt-opt-20": "20 → Exit Toolkit",
    ...
    "txt-fl-t": "Change Language (Menu L):",
        ...
        "txt-f2-t": "System Health Checker (Menu 2):",
        "txt-f2-d": "Runs SFC (System File Checker) and DISM repair tools to find and fix corrupt Windows system files automatically.",
        "txt-f3-t": "PC Maintenance Suite (Menu 3):",
        "txt-f3-d": "Provides a guided, comprehensive multi-step maintenance routine including registry optimization, cache rebuilds, and disk checks.",
        "txt-f4-t": "Updates & Drivers Center (Menu 4):",
        "txt-f4-d": "Fixes stuck or failed Windows Updates by resetting the update services (wuauserv, bits, cryptSvc) and renaming the download cache folder.",
        "txt-f5-t": "Memory Optimizer (Menu 5):",
        "txt-f5-d": "Instantly clears system standby memory and releases unused RAM caches, helping to speed up system responsiveness and games.",
        "txt-f6-t": "Defrag & Optimize Drives (Menu 6):",
        "txt-f6-d": "Analyzes and runs TRIM command for SSDs or defragments HDDs to maintain high drive read/write speeds.",
        ...
        "txt-f8-t": "Visual FX Booster (Menu 8):",
        "txt-f8-d": "Optimizes system visual effects and animations to boost speed and performance, especially on older hardware.",
        "txt-f9-t": "Smart Uninstaller (Menu 9):",
        "txt-f9-d": "Quickly search and remove installed programs using fuzzy logic search. Just type the app name or initials!",
        "txt-f10-t": "Remote Desktop (RDP) Manager (Menu 10):",
        "txt-f10-d": "Allows you to quickly enable, disable, and configure Windows Remote Desktop settings and port configuration.",
        "txt-f11-t": "Enhanced Junk Cleaner (Menu 11):",
        "txt-f11-d": "Safely removes temporary files, system log files, and browser caches (Chrome, Edge, Brave). Also cleans shader caches for <b>AMD, NVIDIA, and Intel</b> GPUs to fix game stuttering issues.",
        "txt-f12-t": "Clear App Caches (Menu 12):",
        "txt-f12-d": "Cleans temporary files and caches for popular apps like Discord, WhatsApp, Spotify, and Steam to recover wasted disk space.",
        "txt-f13-t": "Clear Browser Caches (Menu 13):",
        "txt-f13-d": "Cleans temporary files and caches for popular web browsers including Google Chrome, Microsoft Edge, Mozilla Firefox, and Brave.",
        "txt-f14-t": "Empty Recycle Bin (Menu 14):",
        "txt-f14-d": "Instantly empties the Windows Recycle Bin for all users and drives to free up space.",
        "txt-f15-t": "Open Disk Cleanup (Menu 15):",
        "txt-f15-d": "Launches the official Windows Disk Cleanup utility (cleanmgr) for advanced system file cleanup.",
        ...
        "txt-f17-t": "Network Repair (Menu 17):",
        "txt-f17-d": "Runs a complete 5-step network reset: Release/Renew IP, Flush DNS, Reset Winsock, and Reset TCP/IP stack. Useful for fixing connection drops.",
        "txt-f18-t": "DNS Changer (Menu 18):",
        "txt-f18-d": "Allows you to quickly change your DNS server settings to popular secure options like Google Public DNS or Cloudflare for faster, safer browsing.",
        "txt-f19-t": "Wi-Fi Password Recovery (Menu 19):",
        "txt-f19-d": "Quickly retrieves and displays saved Wi-Fi profiles and passwords on your current machine.",
        "txt-f20-t": "Exit Toolkit (Menu 20):",
        "txt-f20-d": "Safely closes the console window and restores your original PowerShell execution policies.",
  ...
  id: {
    ...
    "txt-other-projects-title": "<i class=\"fas fa-cubes\" style=\"color: #38bdf8;\"></i> Proyek Lainnya",
    "txt-other-projects-desc": "Jelajahi web app dan piranti saya yang lain yang dirancang untuk mempermudah pengembangan dan pembelajaran.",
    "txt-sql-title": "Cheat Sheet SQL",
    "txt-sql-desc": "Panduan kueri SQL interaktif dan contekan referensi cepat.",
    "txt-cta-sql": "Kunjungi Situs &rarr;",
    ...
    /* MENU_TRANS_ID_START */
        ...
        "txt-opt-2": "2 → Pemeriksa Kesehatan Sistem",
        "txt-opt-3": "3 → Pemeliharaan Satu Klik",
        "txt-opt-4": "4 → Pusat Update & Driver",
        "txt-opt-5": "5 → Optimasi Memori",
        "txt-opt-6": "6 → Defragment & Optimasi Drive",
        "txt-opt-7": "7 → Utilitas Daya & Baterai",
        "txt-opt-8": "8 → Visual FX Booster",
        "txt-opt-9": "9 → Smart Uninstaller",
        "txt-opt-10": "10 → Remote Desktop (RDP) Manager",
        "txt-opt-11": "11 → Pembersih Sampah (Enhanced)",
        "txt-opt-12": "12 → Pembersih Cache Aplikasi",
        "txt-opt-13": "13 → Bersihkan Cache Browser",
        "txt-opt-14": "14 → Kosongkan Recycle Bin",
        "txt-opt-15": "15 → Buka Disk Cleanup",
        "txt-opt-16": "16 → Hapus Event Logs",
        "txt-opt-17": "17 → Perbaikan Jaringan",
        "txt-opt-18": "18 → Pengubah DNS",
        "txt-opt-19": "19 → Wi-Fi Password Recovery",
        "txt-opt-20": "20 → Keluar Aplikasi",
    ...
    "txt-fl-t": "Ubah Bahasa (Menu L):",
        ...
        "txt-f2-t": "Pemeriksa Kesehatan Sistem (Menu 2):",
        "txt-f2-d": "Menjalankan SFC (System File Checker) dan DISM repair tools untuk mencari dan memperbaiki file sistem Windows yang rusak atau korup secara otomatis.",
        "txt-f3-t": "Pusat Pemeliharaan Sistem (Menu 3):",
        "txt-f3-d": "Menyediakan rutinitas pemeliharaan multi-langkah yang dipandu, termasuk optimasi registry, pembangunan ulang cache, dan pemeriksaan disk secara menyeluruh.",
        "txt-f4-t": "Pusat Update & Driver (Menu 4):",
        "txt-f4-d": "Memperbaiki Windows Update yang macet atau gagal dengan mereset layanan update (wuauserv, bits, cryptSvc) and mengganti nama folder cache download.",
        "txt-f5-t": "Optimasi Memori (Menu 5):",
        "txt-f5-d": "Membersihkan standby memory dan melepaskan cache RAM yang tidak terpakai secara instan untuk mempercepat respons sistem dan game.",
        "txt-f6-t": "Defragment & Optimasi Drive (Menu 6):",
        "txt-f6-d": "Menganalisis dan menjalankan perintah TRIM untuk SSD atau mendefrag HDD guna mempertahankan kecepatan baca/tulis penyimpanan yang optimal.",
        ...
        "txt-f8-t": "Visual FX Booster (Menu 8):",
        "txt-f8-d": "Mengoptimalkan efek visual dan animasi Windows untuk meningkatkan kecepatan dan performa sistem, sangat berguna pada PC spesifikasi rendah.",
        "txt-f9-t": "Smart Uninstaller (Menu 9):",
        "txt-f9-d": "Cari dan hapus program terinstall dengan cepat menggunakan pencarian pintar. Cukup ketik nama aplikasi atau inisialnya!",
        "txt-f10-t": "Manajer Remote Desktop (RDP) (Menu 10):",
        "txt-f10-d": "Memungkinkan Anda mengaktifkan, menonaktifkan, dan mengonfigurasi pengaturan Remote Desktop Windows serta konfigurasi port.",
        "txt-f11-t": "Enhanced Junk Cleaner (Menu 11):",
        "txt-f11-d": "Menghapus file sementara, file log sistem, dan cache browser (Chrome, Edge, Brave) dengan aman. Juga membersihkan cache shader untuk GPU <b>AMD, NVIDIA, dan Intel</b> guna mengatasi masalah patah-patah (stuttering) saat bermain game.",
        "txt-f12-t": "Pembersih Cache Aplikasi (Menu 12):",
        "txt-f12-d": "Membersihkan file sementara dan cache untuk aplikasi populer seperti Discord, WhatsApp, Spotify, dan Steam guna memulihkan ruang penyimpanan.",
        "txt-f13-t": "Bersihkan Cache Browser (Menu 13):",
        "txt-f13-d": "Membersihkan file sementara dan cache untuk browser web populer termasuk Google Chrome, Microsoft Edge, Mozilla Firefox, dan Brave.",
        "txt-f14-t": "Kosongkan Recycle Bin (Menu 14):",
        "txt-f14-d": "Mengosongkan Recycle Bin secara instan untuk semua pengguna dan drive untuk melegakan penyimpanan.",
        "txt-f15-t": "Buka Disk Cleanup (Menu 15):",
        "txt-f15-d": "Membuka utilitas bawaan Windows Disk Cleanup (cleanmgr) untuk pembersihan file sistem tingkat lanjut.",
        ...
        "txt-f17-t": "Perbaikan Jaringan (Menu 17):",
        "txt-f17-d": "Menjalankan reset jaringan 5 langkah: Release/Renew IP, Flush DNS, Reset Winsock, dan Reset stack TCP/IP. Berguna untuk memperbaiki koneksi yang sering putus.",
        "txt-f18-t": "Pengubah DNS (Menu 18):",
        "txt-f18-d": "Mempermudah Anda mengubah pengaturan DNS sistem ke penyedia DNS aman terpopuler seperti Google Public DNS atau Cloudflare demi koneksi yang lebih cepat dan aman.",
        "txt-f19-t": "Wi-Fi Password Recovery (Menu 19):",
        "txt-f19-d": "Melihat kembali profil dan kata sandi Wi-Fi yang tersimpan di komputer Anda dengan cepat.",
        "txt-f20-t": "Keluar Aplikasi (Menu 20):",
        "txt-f20-d": "Keluar dari jendela konsol toolkit dengan aman dan mengembalikan kebijakan eksekusi (execution policy) PowerShell Anda ke semula.",
  ...
  ja: {
    ...
    "txt-other-projects-title": "<i class=\"fas fa-cubes\" style=\"color: #38bdf8;\"></i> その他のプロジェクト",
    "txt-other-projects-desc": "開発や学習をより簡単にするために設計された、他のウェブアプリやツールをご覧ください。",
    "txt-sql-title": "SQLチートシート",
    "txt-sql-desc": "インタラクティブなSQLクエリガイドとクイックリファレンス。",
    "txt-cta-sql": "サイトを訪ねる &rarr;",
    ...
    "txt-fl-t": "言語の変更 (メニュー L):",
        ...
        "txt-f2-t": "システム修復チェッカー (メニュー 2):",
        "txt-f2-d": "SFC（システムファイルチェッカー）とDISM自動修復スキャンを実行し、破損したコアWindowsファイルを検索・自動復旧します。",
        "txt-f3-t": "PCメンテナンススイート (メニュー 3):",
        "txt-f3-d": "レジストリ最適化、各種キャッシュの再構築、ディスクエラーチェックなどを含む、ガイド付きの包括的な複数ステップのメンテナンスを実行します。",
        "txt-f4-t": "更新プログラム＆ドライバーセンター (メニュー 4):",
        "txt-f4-d": "Windows Updateサービス（wuauserv、bits、cryptSvc）を一時的に安全リセットし、キャッシュ破損フォルダをリネームすることでアップデートの進行エラーを解消します。",
        "txt-f5-t": "メモリ最適化 (メニュー 5):",
        "txt-f5-d": "スタンバイメモリや未使用のRAMキャッシュを瞬時に一括解放し、システム応答速度やゲーム中のパフォーマンスを向上させます。",
        "txt-f6-t": "ドライブ最適化とデフラグ (メニュー 6):",
        "txt-f6-d": "SSD向けにTRIMコマンドを安全に実行、またはHDD向けに最適化（デフラグ）処理を実行し、高速な読み書き速度を維持します。",
        "txt-f7-t": "電源とバッテリーユーティリティ (メニュー 7):",
        "txt-f7-d": "詳細なバッテリー健康状態レポート（HTML形式）を生成し、高パフォーマンス電源プランを構成してスリープ状態を高度に管理します。",
        "txt-f8-t": "Visual FXブースター (メニュー 8):",
        "txt-f8-d": "余計なアニメーションや視覚効果を最適化し、低スペックPCや古いハードウェアでのレスポンスと快適性を高めます。",
        "txt-f9-t": "スマートアンインストーラー (メニュー 9):",
        "txt-f9-d": "あいまい検索機能（Fuzzy Search）を用いて、インストールされているアプリを高速検索。アプリ名の頭文字を入力するだけで安全にアンインストールできます。",
        "txt-f10-t": "リモートデスクトップ (RDP) マネージャー (メニュー 10):",
        "txt-f10-d": "Windows リモートデスクトップ設定およびポート構成をすばやく有効化、無効化、および構成できます。",
        "txt-f11-t": "拡張ジャンククリーナー (メニュー 11):",
        "txt-f11-d": "一時ファイル、システムログファイル、および各種ブラウザキャッシュ（Chrome、Edge、Brave）を安全にクリーンアップします。<b>AMD、NVIDIA、Intel</b>のGPUシェーダーキャッシュも削除し、ゲームの遅延・カクつき問題を解消します。",
        "txt-f12-t": "アプリキャッシュのクリーンアップ (メニュー 12):",
        "txt-f12-d": "Discord、WhatsApp、Spotify、Steamなどの一般的なアプリの一時ファイルやキャッシュをクリーンアップし、空き容量を回復します。",
        "txt-f13-t": "ブラウザキャッシュのクリア (メニュー 13):",
        "txt-f13-d": "Google Chrome、Microsoft Edge、Mozilla Firefox、Brave などの主要な Web ブラウザのテンポラリファイルとキャッシュをクリアします。",
        "txt-f14-t": "ごみ箱を空にする (メニュー 14):",
        "txt-f14-d": "全ユーザーおよび全ドライブのごみ箱の中身をすばやく空にし、ストレージ容量を解放します。",
        "txt-f15-t": "ディスククリーンアップの起動 (メニュー 15):",
        "txt-f15-d": "Windows公式のディスククリーンアップユーティリティ（cleanmgr）を直接起動し、高度なシステムクリーンアップを実行します。",
        "txt-f16-t": "イベントログのクリア (メニュー 16):",
        "txt-f16-d": "Windowsイベントビューアーのすべてのログ（アプリケーション、セキュリティ、システムなど）を安全に消去し、容量解放とプライバシー保護を行います。",
        "txt-f17-t": "ネットワーク修復 (メニュー 17):",
        "txt-f17-d": "IPの再取得、DNSキャッシュクリア、Winsockリセット、TCP/IPスタック再構築を含む包括的な5ステップの接続リセットを実行し、ネット障害を解消します。",
        "txt-f18-t": "DNSチェンジャー (メニュー 18):",
        "txt-f18-d": "Google Public DNSやCloudflareなどの安全で超高速なパブリックDNSサーバーに、設定をすばやく安全に切り替えます。",
        "txt-f19-t": "Wi-Fiパスワード復元 (メニュー 19):",
        "txt-f19-d": "現在お使いのPC内に過去に保存されたすべてのWi-Fiプロファイル名と接続パスワードを瞬時に検出し、一覧表示します。",
        "txt-f20-t": "ツールキットの終了 (メニュー 20):",
        "txt-f20-d": "コンソールウィンドウを安全に閉じ、一時的に適用していたPowerShell実行ポリシーを元の安全な既定状態に自動復元します。",
  ...
  ko: {
    ...
    "txt-other-projects-title": "<i class=\"fas fa-cubes\" style=\"color: #38bdf8;\"></i> 기타 프로젝트",
    "txt-other-projects-desc": "개발과 학습을 더 쉽게 만들도록 설계된 다른 웹 앱과 도구를 살펴보세요.",
    "txt-sql-title": "SQL 치트 시트",
    "txt-sql-desc": "대화형 SQL 쿼리 가이드 및 빠른 참조 치트 시트.",
    "txt-cta-sql": "사이트 방문 &rarr;",
    ...
    "txt-fl-t": "언어팩 조절 (메뉴 L):",
        ...
        "txt-f2-t": "시스템 진단 및 자가치유 (메뉴 2):",
        "txt-f2-d": "윈도우 코어 파일의 교란 여부를 체크하는 SFC 및 DISM 원격 레포지토리 복구를 가동해 알 수 없는 프리징이나 크래시 잦은 오류를 복원합니다.",
        "txt-f3-t": "PC 종합 유지보수 센터 (메뉴 3):",
        "txt-f3-d": "레지스트리 최적화, 각종 캐시 파일 재구축, 디스크 무결성 검사 등 단계별 가이드가 포함된 종합 시스템 유지보수 과정을 안전하게 수행합니다.",
        "txt-f4-t": "업데이트 오류 전담팀 (메뉴 4):",
        "txt-f4-d": "진행이 멈춘 윈도우 업데이트 서비스를 잠시 비활성하고 다운로드 파일 경로를 리셋하여 고질적인 업데이트 먹통 문제를 정면 돌파합니다.",
        "txt-f5-t": "메모리 점유율 완화 (메뉴 5):",
        "txt-f5-d": "가용 자원을 과도하게 잡고 있는 시스템 대기 영역 및 캐싱 메모리 잔여분을 청소해 게임 반응성과 전반적인 체감 로딩 속도를 향상시킵니다.",
        "txt-f6-t": "드라이브 보존 트림 (메뉴 6):",
        "txt-f6-d": "SSD의 효율 유지를 돕는 TRIM 명령을 실행하거나 HDD의 내부 저장 최적화 처리를 병행해 읽기/쓰기 지속 속도를 가다듬습니다.",
        "txt-f7-t": "전원 및 배터리 분석 (메뉴 7):",
        "txt-f7-d": "HTML 규격으로 배터리 열화 수치 및 상태 보고서를 만들고, 고성능 전원 프로필 세팅과 세부 전원 대기 단계를 체계적으로 설정합니다.",
        "txt-f8-t": "성능 중점 Visual FX 조율 (메뉴 8):",
        "txt-f8-d": "윈도우 내 과도하게 펼쳐진 시각 전용 트랜지션 연출들을 경량화 조율하여 구형 장비나 노트북에서 한층 기민한 조작 반응을 확보합니다.",
        "txt-f9-t": "고속 프로그램 삭제 (메뉴 9):",
        "txt-f9-d": "지능형 검색 기능을 탑재하여 프로그램 이름 일부나 초성 및 영문 철자만 입력해도 설치 리스트에서 식별하여 원스톱 제거해줍니다.",
        "txt-f10-t": "원격 데스크톱 (RDP) 관리자 (메뉴 10):",
        "txt-f10-d": "Windows 원격 데스크톱 설정 및 포트 구성을 신속하게 활성화, 비활성화 및 구성할 수 있습니다.",
        "txt-f11-t": "스마트 시스템 정비 (메뉴 11):",
        "txt-f11-d": "불필요한 시스템 임시 리포트, 브라우저 가중 캐시(크롬, 웨일, 엣지)를 정밀 조준 세척합니다. 추가로 <b>AMD, NVIDIA, Intel</b> 그래픽 처리장치의 셰이더 캐시도 정비해 스터터링 현상을 완화합니다.",
        "txt-f12-t": "앱 캐시 정리 (메뉴 12):",
        "txt-f12-d": "Discord, WhatsApp, Spotify, Steam 등 자주 사용하는 주요 애플리케이션의 임시 파일 및 캐시를 말끔히 정리하여 하드 디스크 여유 공간을 복구합니다.",
        "txt-f13-t": "브라우저 캐시 정리 (메뉴 13):",
        "txt-f13-d": "Google Chrome, Microsoft Edge, Mozilla Firefox, Brave 등 주요 웹 브라우저의 임시 파일과 캐시를 정리합니다.",
        "txt-f14-t": "휴지통 자동 청소 (메뉴 14):",
        "txt-f14-d": "모든 디렉토리 및 로컬 계정들의 윈도우 휴지통 잔존 파일을 완전 영구 삭제하여 수동 마우스 클릭의 수고를 덜어줍니다.",
        "txt-f15-t": "Disk Cleanup 실행 (메뉴 15):",
        "txt-f15-d": "OS 기본 내장 유틸리티인 cleanmgr을 직접 호출해 불필요하게 남아있는 업데이트 캐시 파일 등 고급 정리 마법사를 구동합니다.",
        "txt-f16-t": "이벤트 로그 정리 (메뉴 16):",
        "txt-f16-d": "Windows 이벤트 뷰어의 모든 로그(애플리케이션, 보안, 시스템 등)를 삭제하여 시스템 저장 공간을 늘리고 개인 정보 노출을 방지합니다.",
        "txt-f17-t": "인터넷 망 복구 (메뉴 17):",
        "txt-f17-d": "IP 정보 갱신, DNS 캐시 플러시, Winsock 복원, TCP/IP 오버헤드 초기화를 묶어 연결 끊김 현상을 해결하는 5단계 네트워크 재수립 작업을 엽니다.",
        "txt-f18-t": "고성능 DNS 이식 (메뉴 18):",
        "txt-f18-d": "인터넷 응답 반응이 빠른 검증된 퍼블릭 서버(구글 DNS, 클라우드플레어 등)로 네트워크 네임서버 세팅을 민첩하게 교정합니다.",
        "txt-f19-t": "Wi-Fi 비밀번호 발굴 (메뉴 19):",
        "txt-f19-d": "현재 연결된 디바이스에 축적된 와이파이 네트워크 SSID 기록과 기억나지 않는 이전 키를 찾아 터미널에 보여줍니다.",
        "txt-f20-t": "대화형 툴킷 프로그램 종료 (메뉴 20):",
        "txt-f20-d": "콘솔 창을 안전하게 닫고 변경되었던 PowerShell 실행 정책을 원래의 기본 권한 상태로 자동 복원합니다.",
  ...
  zh: {
    ...
    "txt-other-projects-title": "<i class=\"fas fa-cubes\" style=\"color: #38bdf8;\"></i> 其他项目",
    "txt-other-projects-desc": "探索我的其他 Web 应用程序和工具，旨在简化开发和学习。",
    "txt-sql-title": "SQL 备忘单",
    "txt-sql-desc": "交互式 SQL 查询指南和快速参考备忘单。",
    "txt-cta-sql": "访问网站 &rarr;",
    ...
    "txt-fl-t": "切换语言 (菜单 L)：",
        ...
        "txt-f2-t": "系统健康检查 (菜单 2)：",
        "txt-f2-d": "运行 SFC（系统文件检查器）及 DISM 修复工具，自动扫描并修复已损坏的 Windows 系统文件。",
        "txt-f3-t": "PC 综合维护套件 (菜单 3):",
        "txt-f3-d": "提供引导式的多步骤综合日常维护，包括注册表优化、缓存重建和磁盘错误检查。",
        "txt-f4-t": "更新与驱动中心 (菜单 4)：",
        "txt-f4-d": "通过重置更新服务（wuauserv、bits、cryptSvc）并重命名下载缓存文件夹，修复卡住或失败的 Windows 更新。",
        "txt-f5-t": "内存优化 (菜单 5)：",
        "txt-f5-d": "瞬间清理系统备用内存并释放闲置 RAM 缓存，提升系统响应速度与游戏帧率。",
        "txt-f6-t": "驱动器碎片整理与优化 (菜单 6)：",
        "txt-f6-d": "对固态硬盘 (SSD) 执行 TRIM 指令或对机械硬盘 (HDD) 进行碎片整理，维持极速读写性能。",
        "txt-f7-t": "电源与电池实用程序 (菜单 7)：",
        "txt-f7-d": "生成详细的 HTML 电池健康报告，配置高性能电源计划，并管理系统睡眠状态。",
        "txt-f8-t": "视觉效果加速器 (菜单 8)：",
        "txt-f8-d": "优化系统动画与视觉效果，显著提升系统运行速度和流畅度，老旧电脑必备。",
        "txt-f9-t": "智能卸载程序 (菜单 9)：",
        "txt-f9-d": "使用模糊搜索快速查找并卸载已安装的软件。只需输入软件名称或首字母拼音！",
        "txt-f10-t": "远程桌面 (RDP) 管理器 (菜单 10)：",
        "txt-f10-d": "允许您快速启用、禁用和配置 Windows 远程桌面设置及端口配置。",
        "txt-f11-t": "增强版垃圾清理 (菜单 11)：",
        "txt-f11-d": "安全删除临时文件、系统日志和浏览器缓存（Chrome、Edge、Brave）。同时清理 <b>AMD、NVIDIA 及 Intel</b> 显卡着色器缓存，解决游戏卡顿问题。",
        "txt-f12-t": "清除应用缓存 (菜单 12):",
        "txt-f12-d": "清理 Discord、WhatsApp、Spotify 和 Steam 等常用软件的临时文件与缓存，以恢复流失的磁盘空间。",
        "txt-f13-t": "清理浏览器缓存 (菜单 13)：",
        "txt-f13-d": "清理主流网页浏览器（包括 Google Chrome、Microsoft Edge、Mozilla Firefox 和 Brave）的临时文件和缓存。",
        "txt-f14-t": "清空回收站 (菜单 14)：",
        "txt-f14-d": "一键清空所有用户及磁盘驱动器的 Windows 回收站，释放存储空间。",
        "txt-f15-t": "打开磁盘清理 (菜单 15)：",
        "txt-f15-d": "启动官方 Windows 磁盘清理工具 (cleanmgr)，进行高级系统文件清理。",
        "txt-f16-t": "清除事件日志 (菜单 16):",
        "txt-f16-d": "清除 Windows 事件查看器中的所有日志（应用程序、安全、系统等），释放空间并保护系统隐私。",
        "txt-f17-t": "网络修复 (菜单 17)：",
        "txt-f17-d": "执行完整的 5 步网络重置：释放/续约 IP、刷新 DNS、重置 Winsock 及 TCP/IP 协议栈，有效解决断网问题。",
        "txt-f18-t": "DNS 切换工具 (菜单 18)：",
        "txt-f18-d": "快速切换至 Google Public DNS 或 Cloudflare 等知名安全 DNS，享受更快、更安全的网络浏览。",
        "txt-f19-t": "Wi-Fi 密码找回 (菜单 19)：",
        "txt-f19-d": "快速检索并显示当前电脑中保存的所有 Wi-Fi 网络名称及密码。",
        "txt-f20-t": "退出工具箱 (菜单 20):",
        "txt-f20-d": "安全关闭控制台窗口，并将您的系统 PowerShell 执行策略恢复至默认设置。",
  ...
  ar: {
    ...
    "txt-other-projects-title": "<i class=\"fas fa-cubes\" style=\"color: #38bdf8;\"></i> مشاريع أخرى",
    "txt-other-projects-desc": "استكشف تطبيقات وأدوات الويب الأخرى المصممة لتسهيل التطوير والتعلم.",
    "txt-sql-title": "ورقة مرجعية لـ SQL",
    "txt-sql-desc": "دليل استعلام SQL تفاعلي ورقة مرجعية سريعة.",
    "txt-cta-sql": "زيارة الموقع &larr;",
    ...
    "txt-fl-t": "تغيير اللغة (القائمة L):",
        ...
        "txt-f2-t": "فحص صحة النظام (القائمة 2):",
        "txt-f2-d": "يشغل أدوات الفحص والإصلاح (SFC و DISM) للعثور على ملفات نظام Windows التالفة وإصلاحها تلقائياً.",
        "txt-f3-t": "حزمة صيانة الكمبيوتر المتكاملة (القائمة 3):",
        "txt-f3-d": "يوفر روتين صيانة شاملاً وموجهاً متعدد الخطوات يتضمن تحسين الريجستري وإعادة بناء ذاكرة التخزين المؤقت وفحص القرص.",
        "txt-f4-t": "مركز التحديثات والتعريفات (القائمة 4):",
        "txt-f4-d": "يصلح تحديثات Windows العالقة أو الفاشلة عن طريق إعادة تشغيل خدمات التحديث (wuauserv, bits, cryptSvc) وإعادة تسمية مجلد التنزيل المؤقت.",
        "txt-f5-t": "محسن الذاكرة (القائمة 5):",
        "txt-f5-d": "يمسح الذاكرة الاحتياطية ويحرر الذاكرة العشوائية غير المستخدمة على الفور، مما يساعد على تسريع استجابة النظام والألعاب.",
        "txt-f6-t": "إلغاء التجزئة وتحسين الأقراص (القائمة 6):",
        "txt-f6-d": "يحلل ويشغل أمر TRIM لأقراص SSD أو يلغي تجزئة أقراص HDD للحفاظ على سرعات قراءة وكتابة عالية.",
        ...
        "txt-f8-t": "معزز التأثيرات المرئية (القائمة 8):",
        "txt-f8-d": "يحسن التأثيرات المرئية والرسوم المتحركة للنظام لزيادة السرعة والأداء، خاصة على الأجهزة القديمة.",
        "txt-f9-t": "إلغاء التثبيت الذكي (القائمة 9):",
        "txt-f9-d": "ابحث عن البرامج المثبتة وأزلها بسرعة باستخدام البحث الذكي. ما عليك سوى كتابة اسم التطبيق أو أحرفه الأولى!",
        "txt-f10-t": "مدير سطح المكتب البعيد (RDP) (القائمة 10):",
        "txt-f10-d": "يسمح لك بتمكين وتعطيل وتكوين إعدادات سطح المكتب البعيد لـ Windows وتكوين المنافذ بسرعة.",
        "txt-f11-t": "منظف المخلفات المطور (القائمة 11):",
        "txt-f11-d": "يزيل الملفات المؤقتة وسجلات النظام ومخلفات المتصفحات (Chrome, Edge, Brave) بأمان. ينظف أيضاً ملفات التظليل (Shader Cache) لكروت الشاشة <b>AMD, NVIDIA, Intel</b> لحل مشكلات التقطيع في الألعاب.",
        "txt-f12-t": "مسح ذاكرة التخزين المؤقت للتطبيقات (القائمة 12):",
        "txt-f12-d": "ينظف الملفات المؤقتة وذاكرة التخزين المؤقت للتطبيقات الشائعة مثل Discord و WhatsApp و Spotify و Steam لاستعادة مساحة القرص الضائعة.",
        "txt-f13-t": "مسح ذاكرة التخزين المؤقت للمتصفح (القائمة 13):",
        "txt-f13-d": "ينظف الملفات المؤقتة وذاكرة التخزين المؤقت لمتصفحات الويب الشائعة بما في ذلك Google Chrome و Microsoft Edge و Mozilla Firefox و Brave.",
        "txt-f14-t": "إفراغ سلة المحذوفات (القائمة 14):",
        "txt-f14-d": "يفرغ سلة المحذوفات في Windows لجميع المستخدمين والأقراص بضغطة واحدة لتحرير المساحة.",
        "txt-f15-t": "تنظيف القرص (القائمة 15):",
        "txt-f15-d": "يفتح أداة Windows الرسمية (cleanmgr) لتنظيف ملفات النظام المتقدمة.",
        ...
        "txt-f17-t": "إصلاح الشبكة (القائمة 17):",
        "txt-f17-d": "يقوم بإعادة ضبط الشبكة بالكامل عبر 5 خطوات: تجديد IP، مسح DNS، إعادة ضبط Winsock، ومكدس TCP/IP لحل انقطاع الاتصال.",
        "txt-f18-t": "مغير DNS (القائمة 18):",
        "txt-f18-d": "يتيح لك تغيير إعدادات خادم DNS بسرعة إلى خيارات آمنة وسريعة مثل Google Public DNS أو Cloudflare لتصفح أكثر سرعة وأماناً.",
        "txt-f19-t": "استعادة كلمات مرور Wi-Fi (القائمة 19):",
        "txt-f19-d": "يستخرج ويعرض جميع أسماء شبكات Wi-Fi المحفوظة وكلمات المرور الخاصة بها على جهازك فوراً.",
        "txt-f20-t": "الخروج من الأداة (القائمة 20):",
        "txt-f20-d": "يغلق نافذة أداة التحكم بأمان ويعيد سياسات تشغيل PowerShell إلى وضعها الأصلي.",
  ...
  jv: {
    ...
    "txt-other-projects-title": "<i class=\"fas fa-cubes\" style=\"color: #38bdf8;\"></i> Proyek Liyane",
    "txt-other-projects-desc": "Jelajahi aplikasi web lan piranti liyane sing digawe kanggo nggampangake pangembangan lan sinau.",
    "txt-sql-title": "SQL Cheat Sheet",
    "txt-sql-desc": "Panduan pitakon SQL interaktif lan contekan referensi cepet.",
    "txt-cta-sql": "Dolan Situs &rarr;",
    ...
    "txt-fl-t": "Gantos Basa (Menu L):",
        ...
        "txt-f2-t": "Pamariksan Kasarasan Sistem (Menu 2):",
        "txt-f2-d": "Nglampahaken SFC (System File Checker) saha DISM repair tools kagem madosi saha ndandani file sistem Windows ingkang risak kanthi otomatis.",
        "txt-f3-t": "Pusat Pemeliharaan Sistem (Menu 3):",
        "txt-f3-d": "Nyawisaken rutinitas pemeliharaan multi-langkah ingkang dipuntuntun, kalebet optimasi registry, mbangun malih cache, saha pamariksan disk kanthi jangkep.",
        "txt-f4-t": "Pusat Update & Driver (Menu 4):",
        "txt-f4-d": "Ndandani Windows Update ingkang macet utawi gagal kanthi mereset layanan update (wuauserv, bits, cryptSvc) saha nggantos nama folder cache undhuhan.",
        "txt-f5-t": "Optimasi Memori (Menu 5):",
        "txt-f5-d": "Ngresiki standby memory saha mbebasaken cache RAM ingkang mboten dipunginakaken kanthi instan kagem nambah kacepetan respons sistem saha game.",
        "txt-f6-t": "Defragment & Optimasi Drive (Menu 6):",
        "txt-f6-d": "Mriksa saha nglampahaken perintah TRIM kagem SSD utawi mendefrag HDD supados kacepetan maos/nyerat panyimpenan tetep inggil.",
        "txt-f7-t": "Utilitas Daya & Baterai (Menu 7):",
        ...
        "txt-f8-t": "Visual FX Booster (Menu 8):",
        "txt-f8-d": "Ngoptimalaken efek visual saha animasi Windows kagem nambah kacepetan saha performa sistem, migunani sanget ing PC spesifikasi andhap.",
        "txt-f9-t": "Smart Uninstaller (Menu 9):",
        "txt-f9-d": "Padosi saha mbusak program terinstal kanthi cepet migunakaken pencarian pinter. Cukup ketik nama aplikasi utawi inisialipun!",
        "txt-f10-t": "Manajer Remote Desktop (RDP) (Menu 10):",
        "txt-f10-d": "Ngidini sampeyan ngaktifake, mateni, lan ngonfigurasi setelan Windows Remote Desktop lan konfigurasi port.",
        "txt-f11-t": "Enhanced Junk Cleaner (Menu 11):",
        "txt-f11-d": "Mbusak file sauntara, file log sistem, saha cache browser (Chrome, Edge, Brave) kanthi aman. Ugi ngresiki cache shader GPU <b>AMD, NVIDIA, saha Intel</b> supados mboten patah-patah nalika main game.",
        "txt-f12-t": "Pangresik Cache Aplikasi (Menu 12):",
        "txt-f12-d": "Ngresiki file sauntara saha cache kagem aplikasi populer kados Discord, WhatsApp, Spotify, saha Steam kagem mulihaken ruang panyimpenan.",
        "txt-f13-t": "Ngresiki Cache Browser (Menu 13):",
        "txt-f13-d": "Ngresiki file sawuntara lan cache kanggo browser web populer kalebu Google Chrome, Microsoft Edge, Mozilla Firefox, lan Brave.",
        "txt-f14-t": "Kosongaken Recycle Bin (Menu 14):",
        "txt-f14-d": "Ngosongaken Recycle Bin kanthi instan kagem sedaya pangguna saha drive kagem nglegakaken panyimpenan.",
        "txt-f15-t": "Buka Disk Cleanup (Menu 15):",
        "txt-f15-d": "Mbukak utilitas bawaan Windows Disk Cleanup (cleanmgr) kagem pangresikan file sistem tingkat lanjut.",
        "txt-f16-t": "Hapus Event Logs (Menu 16):",
        ...
        "txt-f17-t": "Perbaikan Jaringan (Menu 17):",
        "txt-f17-d": "Nglampahaken reset jaringan 5 langkah: Release/Renew IP, Flush DNS, Reset Winsock, saha Reset stack TCP/IP. Migunani kagem ndandani koneksi ingkang asring pedhot.",
        "txt-f18-t": "Pangowah DNS (Menu 18):",
        "txt-f18-d": "Nggampilaken panjenengan ngowahi pangaturan DNS sistem menyang panyedia aman populer kados Google Public DNS utawi Cloudflare.",
        "txt-f19-t": "Wi-Fi Password Recovery (Menu 19):",
        "txt-f19-d": "Ningali malih profil saha sandhi Wi-Fi ingkang kasimpen ing komputer panjenengan kanthi cepet.",
        "txt-f20-t": "Medal Saking Aplikasi (Menu 20):",
        "txt-f20-d": "Medal saking konsol toolkit kanthi aman saha ngwangsulaken kebijakan eksekusi (execution policy) PowerShell panjenengan kados wau.",
  ...
  su: {
    ...
    "txt-other-projects-title": "<i class=\"fas fa-cubes\" style=\"color: #38bdf8;\"></i> Proyék Sanésna",
    "txt-other-projects-desc": "Jelajahi aplikasi wéb sareng alat kuring anu sanés anu dirancang pikeun ngagampangkeun pamekaran sareng diajar.",
    "txt-sql-title": "SQL Cheat Sheet",
    "txt-sql-desc": "Pituduh kueri SQL interaktif sareng contekan referensi gancang.",
    "txt-cta-sql": "Buka Situs &rarr;",
    ...
    "txt-fl-t": "Gantos Basa (Menu L):",
        ...
        "txt-f2-t": "Pamariosan Kaséhatan Sistem (Menu 2):",
        "txt-f2-d": "Ngajalankeun SFC (System File Checker) sareng DISM repair tools piken milari sareng ngalereskeun file sistem Windows nu ruksak kalayan otomatis.",
        "txt-f3-t": "Pusat Pemeliharaan Sistem (Menu 3):",
        "txt-f3-d": "Nyiapkeun rutinitas pangropéa multi-langkah nu dipandu, kalebet optimasi registry, ngawangun deui cache, sareng pamariosan disk kalayan jangkep.",
        "txt-f4-t": "Pusat Update & Driver (Menu 4):",
        "txt-f4-d": "Ngalereskeun Windows Update nu macét atanapi gagal ku cara mereset layanan update (wuauserv, bits, cryptSvc) sareng ngagantos nami folder cache unduhan.",
        "txt-f5-t": "Optimasi Mémori (Menu 5):",
        "txt-f5-d": "Ngabersihan standby memory sareng ngabébaskeun cache RAM nu henteu dianggo kalayan instan piken nambah kagancangan respons sistem sareng game.",
        "txt-f6-t": "Defragment & Optimasi Drive (Menu 6):",
        "txt-f6-d": "Marios sareng ngajalankeun perintah TRIM piken SSD atanapi mendefrag HDD supados kagancangan maca/nyerat panyimpenan tetep luhur.",
        "txt-f7-t": "Utilitas Daya & Baterai (Menu 7):",
        ...
        "txt-f8-t": "Visual FX Booster (Menu 8):",
        "txt-f8-d": "Ngoptimalkeun éfék visual sareng animasi Windows piken nambah kagancangan sareng performa sistem, mangpaat pisan dina PC spesifikasi handap.",
        "txt-f9-t": "Smart Uninstaller (Menu 9):",
        "txt-f9-d": "Pilari sareng mupus program terinstal kalayan gancang nganggo panyarian pinter. Cukup ketik nami aplikasi atanapi inisialna!",
        "txt-f10-t": "Manajer Remote Desktop (RDP) (Menu 10):",
        "txt-f10-d": "Ngamungkinkeun anjeun ngaktipkeun, nganonaktipkeun, sareng ngonpigurasikeun setélan Windows Remote Desktop sareng konpigurasi port.",
        "txt-f11-t": "Enhanced Junk Cleaner (Menu 11):",
        "txt-f11-d": "Mupus file samentawis, file log sistem, sareng cache browser (Chrome, Edge, Brave) kalayan aman. Ogé ngabersihan cache shader GPU <b>AMD, NVIDIA, sareng Intel</b> supados henteu patah-patah nalika maén game.",
        "txt-f12-t": "Pangbersih Cache Aplikasi (Menu 12):",
        "txt-f12-d": "Ngabersihan file samentawis sareng cache kanggo aplikasi populér sapertos Discord, WhatsApp, Spotify, sareng Steam piken mulangkeun ruang panyimpenan.",
        "txt-f13-t": "Ngabersihkeun Cache Browser (Menu 13):",
        "txt-f13-d": "Ngabersihkeun file samentara sareng cache pikeun browser wéb populér kaasup Google Chrome, Microsoft Edge, Mozilla Firefox, sareng Brave.",
        "txt-f14-t": "Kosongkeun Recycle Bin (Menu 14):",
        "txt-f14-d": "Ngosongkeun Recycle Bin kalayan instan piken sadaya pangguna sareng drive piken ngalegakeun panyimpenan.",
        "txt-f15-t": "Buka Disk Cleanup (Menu 15):",
        "txt-f15-d": "Muka utilitas bawaan Windows Disk Cleanup (cleanmgr) piken pangbersihan file sistem tingkat lanjut.",
        "txt-f16-t": "Hapus Event Logs (Menu 16):",
        ...
        "txt-f17-t": "Perbaikan Jaringan (Menu 17):",
        "txt-f17-d": "Ngajalankeun reset jaringan 5 langkah: Release/Renew IP, Flush DNS, Reset Winsock, sareng Reset stack TCP/IP. Mangpaat piken ngalereskeun konéksi nu sering pedot.",
        "txt-f18-t": "Pangobah DNS (Menu 18):",
        "txt-f18-d": "Ngagampilkeun anjeun ngobah pangaturan DNS sistem ka panyedia aman populér sapertos Google Public DNS atanapi Cloudflare.",
        "txt-f19-t": "Wi-Fi Password Recovery (Menu 19):",
        "txt-f19-d": "Ningali deui profil sareng sandi Wi-Fi nu kasimpen dina komputer anjeun kalayan gancang.",
        "txt-f20-t": "Kaluar Ti Aplikasi (Menu 20):",
        "txt-f20-d": "Kaluar ti konsol toolkit kalayan aman sareng ngawangsulkeun kawijakan éksekusi PowerShell anjeun sapertos sateuacanna.",
  ...
  hi: {
    ...
    "txt-other-projects-title": "<i class=\"fas fa-cubes\" style=\"color: #38bdf8;\"></i> अन्य परियोजनाएं",
    "txt-other-projects-desc": "विकास और सीखने को आसान बनाने के लिए डिज़ाइन किए गए मेरे अन्य वेब ऐप्स और टूल देखें।",
    "txt-sql-title": "SQL चीट शीट",
    "txt-sql-desc": "इंटरैक्टिव SQL क्वेरी गाइड और त्वरित संदर्भ चीट शीट।",
    "txt-cta-sql": "साइट पर जाएं &rarr;",
    ...
    "txt-fl-t": "भाषा बदलें (मेनू L):",
        ...
        "txt-f2-t": "सिस्टम स्वास्थ्य जांच (मेनू 2):",
        "txt-f2-d": "दूषित विंडोज सिस्टम फ़ाइलों को स्वचालित रूप से खोजने और सुधारने के लिए SFC (सिस्टम फ़ाइल चेकर) और DISM मरम्मत उपकरण चलाता है।",
        "txt-f3-t": "पीसी रखरखाव सुइट (मेनू 3):",
        "txt-f3-d": "रजिस्ट्री अनुकूलन, कैश पुनर्निर्माण और डिस्क त्रुटि जाँच सहित एक निर्देशित, व्यापक बहु-चरणीय रखरखाव दिनчर्या प्रदान करता है.",
        "txt-f4-t": "अपडेट और ड्राइवर केंद्र (मेनू 4):",
        "txt-f4-d": "अपडेट सेवाओं (wuauserv, bits, cryptSvc) को रीसेट करके और डाउनलोड कैश फ़ोल्डर का नाम बदलकर अटके या विफल विंडोज अपडेट को ठीक करता है।",
        "txt-f5-t": "मेमोरी अनुकूलन (मेनू 5):",
        "txt-f5-d": "सिस्टम प्रतिक्रिया और गेमिंग गति में सुधार करने के लिए स्टैंडबाय मेमोरी को साफ़ करें और अप्रयुक्त RAM कैश को तुरंत मुक्त करें।",
        "txt-f6-t": "ड्राइव अनुकूलन (मेनू 6):",
        "txt-f6-d": "SSD के लिए TRIM कमांड की जांच और निष्पादन करता है या पढ़ने/लिखने की गति को उच्च बनाए रखने के लिए HDD को डीफ़्रैग्मेन्ट करता है।",
        ...
        "txt-f8-t": "विज़ुअल इफ़ेक्ट बूस्टर (मेनू 8):",
        "txt-f8-d": "सिस्टम गति और प्रदर्शन को बढ़ाने के लिए विंडोज एनिमेशन और विज़ुअल इफ़ेक्ट्स को अनुकूलित करता है, जो पुराने पीसी पर बहुत उपयोगी है।",
        "txt-f9-t": "स्मार्ट अनइंस्टॉलर (मेनू 9):",
        "txt-f9-d": "स्मार्ट खोज का उपयोग करके स्थापित प्रोग्रामों को तेज़ी से खोजें और अनइंस्टॉल करें। बस एप्लिकेशन का नाम या प्रारंभिक अक्षर टाइप करें!",
        "txt-f10-t": "रिमोट डेस्कटॉप (RDP) प्रबंधक (मेनू 10):",
        "txt-f10-d": "आपको विंडोज रिमोट डेस्कटॉप सेटिंग्स और पोर्ट कॉन्फ़िगरेशन को तुरंत सक्षम, अक्षम और कॉन्फ़िगर करने की अनुमति देता है।",
        "txt-f11-t": "उन्नत जंक क्लीनर (मेनू 11):",
        "txt-f11-d": "अस्थायी फ़ाइलों, सिस्टम लॉग और ब्राउज़र कैश (Chrome, Edge, Brave) को सुरक्षित रूप से साफ़ करता है। गेमिंग हकलाने को रोकने के लिए <b>AMD, NVIDIA और Intel</b> GPU शेडर कैश को भी साफ़ करता है।",
        "txt-f12-t": "ऐप कैश साफ़ करें (मेनू 12):",
        "txt-f12-d": "Discord, WhatsApp, Spotify और Steam जैसे लोकप्रिय ऐप्स के लिए अस्थायी फ़ाइलों और कैश को साफ़ करके डिस्क स्थान पुनर्प्राप्त करता है.",
        "txt-f13-t": "ब्राउज़र कैश साफ़ करें (मेनू 13):",
        "txt-f13-d": "Google Chrome, Microsoft Edge, Mozilla Firefox, और Brave सहित लोकप्रिय वेब ब्राउज़र के लिए अस्थायी फ़ाइलों और कैश को साफ़ करता है।",
        "txt-f14-t": "रीसायकल बिन खाली करें (मेनू 14):",
        "txt-f14-d": "संग्रहण स्थान खाली करने के लिए सभी उपयोगकर्ताओं और ड्राइव के लिए रीसायकल बिन को तुरंत खाली करता है।",
        "txt-f15-t": "डिस्क क्लीनअप खोलें (मेनू 15):",
        "txt-f15-d": "उन्नत सिस्टम फ़ाइल सफाई के लिए अंतर्निहित विंडोज डिस्क क्लीनअप (cleanmgr) उपयोगिता खोलता है।",
        ...
        "txt-f17-t": "नेटवर्क मरम्मत (मेनू 17):",
        "txt-f17-d": "5-चरणीय नेटवर्क रीसेट करता है: IP रीलीज़/रिन्यू, DNS फ़्लश, विंसॉक रीसेट और TCP/IP स्टैक रीसेट। बार-बार डिस्कनेक्ट होने की समस्या को हल करने में मदद करता है।",
        "txt-f18-t": "DNS परिवर्तक (मेनू 18):",
        "txt-f18-d": "आपके लिए सिस्टम DNS सेटिंग्स को लोकप्रिय और सुरक्षित प्रदाताओं जैसे Google Public DNS या Cloudflare में बदलना आसान बनाता है।",
        "txt-f19-t": "वाई-फ़ाई पासवर्ड रिकवरी (मेनू 19):",
        "txt-f19-d": "आपके कंप्यूटर पर सहेजे गए वाई-फ़ाई नेटवर्क नाम और पासवर्ड को तुरंत पुनर्प्राप्त और प्रदर्शित करता है।",
        "txt-f20-t": "टूलकिट से बाहर निकलें (मेनू 20):",
        "txt-f20-d": "सुरक्षित रूप से कंसोल विंडो को बंद करता है और आपकी मूल पावरशेल निष्पादन नीतियों को पुनर्स्थापित करता है.",
  ...
  ru: {
    ...
    "txt-other-projects-title": "<i class=\"fas fa-cubes\" style=\"color: #38bdf8;\"></i> Другие проекты",
    "txt-other-projects-desc": "Посмотрите другие мои веб-приложения и инструменты, созданные для упрощения разработки и обучения.",
    "txt-sql-title": "Шпаргалка по SQL",
    "txt-sql-desc": "Интерактивное руководство по SQL-запросам и шпаргалка.",
    "txt-cta-sql": "Перейти на сайт &rarr;",
    ...
    "txt-fl-t": "Смена языка (Меню L):",
        ...
        "txt-f2-t": "Проверка здоровья системы (Меню 2):",
        "txt-f2-d": "Запуск инструментов сканирования и восстановления (SFC и DISM) для автоматического поиска и исправления поврежденных файлов Windows.",
        "txt-f3-t": "Центр обслуживания ПК (Меню 3):",
        "txt-f3-d": "Интерактивное пошаговое руководство по комплексному обслуживанию системы, включая оптимизацию реестра, пересборку кэша и проверку дисков.",
        "txt-f4-t": "Центр обновлений и драйверов (Меню 4):",
        "txt-f4-d": "Исправление зависших или неудачных обновлений Windows путем перезапуска служб (wuauserv, bits, cryptSvc) и переименования кэша загрузок.",
        "txt-f5-t": "Оптимизация памяти (Меню 5):",
        "txt-f5-d": "Мгновенная очистка резервной памяти и освобождение неиспользуемого кэша RAM для ускорения отклика системы и игр.",
        "txt-f6-t": "Оптимизация дисков (Меню 6):",
        "txt-f6-d": "Проверка и запуск команды TRIM для SSD или дефрагментация HDD для поддержания высокой скорости чтения и записи.",
        ...
        "txt-f8-t": "Ускорение визуальных эффектов (Меню 8):",
        "txt-f8-d": "Оптимизация анимации и визуальных эффектов Windows для повышения скорости и производительности на старых ПК.",
        "txt-f9-t": "Умный деинсталлятор (Меню 9):",
        "txt-f9-d": "Быстрый поиск и удаление установленных программ с помощью умного поиска. Просто введите название или начальные буквы приложения!",
        "txt-f10-t": "Диспетчер удаленного рабочего стола (RDP) (Меню 10):",
        "txt-f10-d": "Позволяет быстро включать, отключать и настраивать параметры удаленного рабочего стола Windows и конфигурацию портов.",
        "txt-f11-t": "Расширенная очистка мусора (Меню 11):",
        "txt-f11-d": "Безопасное удаление временных файлов, системных логов и кэша браузеров (Chrome, Edge, Brave). Также очищает кэш шейдеров <b>AMD, NVIDIA и Intel</b> для устранения фризов в играх.",
        "txt-f12-t": "Очистить кэш приложений (Меню 12):",
        "txt-f12-d": "Безопасная очистка временных файлов и кэша популярных приложений (Discord, WhatsApp, Spotify, Steam) для освобождения занятого места.",
        "txt-f13-t": "Очистка кэша браузера (Меню 13):",
        "txt-f13-d": "Очищает временные файлы и кэш популярных веб-браузеров, включая Google Chrome, Microsoft Edge, Mozilla Firefox и Brave.",
        "txt-f14-t": "Очистка Корзины (Меню 14):",
        "txt-f14-d": "Мгновенная очистка Корзины для всех пользователей и дисков для освобождения места.",
        "txt-f15-t": "Очистка диска (Меню 15):",
        "txt-f15-d": "Запуск встроенной утилиты Windows (cleanmgr) для глубокой очистки системных файлов.",
        ...
        "txt-f17-t": "Восстановление сети (Меню 17):",
        "txt-f17-d": "Выполняет 5-этапный сброс сети: обновление IP, сброс DNS, Winsock и стека TCP/IP. Помогает устранить частые разрывы соединения.",
        "txt-f18-t": "Смена DNS (Меню 18):",
        "txt-f18-d": "Легкое переключение настроек DNS на быстрые и безопасные публичные серверы, такие как Google Public DNS или Cloudflare.",
        "txt-f19-t": "Восстановление паролей Wi-Fi (Меню 19):",
        "txt-f19-d": "Быстрый поиск и отображение всех сохраненных имен сетей Wi-Fi и паролей к ним на вашем ПК.",
        "txt-f20-t": "Выход из утилиты (Меню 20):",
        "txt-f20-d": "Безопасное закрытие окна консоли и автоматическое восстановление исходных политик выполнения PowerShell.",
